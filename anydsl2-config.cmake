...
IF ( ANYDSL2_LIBRARIES_DIR )
    FIND_LIBRARY ( ANYDSL2_LIBRARY_DEBUG NAMES ${ANYDSL2_OUTPUT_LIBS} PATHS ${ANYDSL2_LIBRARIES_DIR} PATH_SUFFIXES Debug)
    FIND_LIBRARY ( ANYDSL2_LIBRARY_RELEASE NAMES ${ANYDSL2_OUTPUT_LIBS} PATHS ${ANYDSL2_LIBRARIES_DIR} PATH_SUFFIXES Release )
    SET ( ANYDSL2_LIBRARIES
        optimized ${ANYDSL2_LIBRARY_RELEASE}
        debug ${ANYDSL2_LIBRARY_DEBUG}
    )
    # get the dependencies
    get_anydsl2_dependency_libs ( ANYDSL2_TEMP_LIBRARIES )
    SET ( ANYDSL2_LIBRARIES ${ANYDSL2_TEMP_LIBRARIES} ${ANYDSL2_LIBRARIES} )
ENDIF ( ANYDSL2_LIBRARIES_DIR )
