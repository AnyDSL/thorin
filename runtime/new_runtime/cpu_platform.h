...
protected:
    ...
    void set_block_size(device_id, unsigned, unsigned, unsigned) { no_kernel(); }
    void set_grid_size(device_id, unsigned, unsigned, unsigned) { no_kernel(); }
    void set_arg(device_id, int, void*) override { no_kernel(); }
