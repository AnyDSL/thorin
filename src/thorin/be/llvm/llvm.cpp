...
std::vector<llvm::Value*> CodeGen::emit_intrinsic(llvm::IRBuilder<>& irbuilder, Continuation* continuation) {
    ...
    switch (callee->intrinsic()) {
        ...
        case Intrinsic::OpenCL_SPIRV:    runtime_->emit_host_code(*this, irbuilder, Runtime::OPENCL_PLATFORM,     ".spv",    continuation); break;
        case Intrinsic::LevelZero_SPIRV: runtime_->emit_host_code(*this, irbuilder, Runtime::LEVEL_ZERO_PLATFORM, ".spv",    continuation); break;
