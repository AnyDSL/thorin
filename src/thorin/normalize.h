...
template<_Cast> const Def* normalize__Cast(const Def*, const Def*, const Def*);
...
constexpr std::array<Def::NormalizeFn, Num<_Cast>> normalizers__Cast = { THORIN_CAST(CODE) };
