...
public:
    ...
    const_iterator begin() const { return filter_iterator(array_.begin(), array_.end(), IsValidPred<Value>::is_valid); }
    const_iterator end() const { return filter_iterator(array_.end(), array_.end(), IsValidPred<Value>::is_valid); }
