...
#include "thorin/tables/cmptable.h"
    ...
    Closure* closure(const ClosureType* closure_type, Debug dbg = {}) { put<Closure>(*this, closure_type, dbg); }
    ...
    const Def* heap(const Def* contents, Debug dbg = {}) { return cse(new Heap(*this, ptr_type(contents->type()), contents, dbg)); }
    ...
    Continuation* static_control(Types tys);
